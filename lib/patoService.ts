    ...
    return patos
      .filter(pato => {
        ...
        const matchesEspecie =
          !filters.especie || pato.especie === filters.especie;
        const matchesHabitat =
          !filters.habitat ||
          pato.habitat.toLowerCase().includes(filters.habitat.toLowerCase());
        const matchesAlimentacion =
          !filters.alimentacion ||
          pato.alimentacion
            .toLowerCase()
            .includes(filters.alimentacion.toLowerCase());
