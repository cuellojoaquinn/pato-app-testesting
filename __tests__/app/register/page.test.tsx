...
describe('RegisterPage', () => {
  ...
  describe('Renderizado inicial', () => {
    it('debe renderizar el formulario de registro correctamente', () => {
      ...
      expect(
        screen.getByText(
          'Únete a Pato App para explorar el mundo de los patos argentinos'
        )
      ).toBeInTheDocument();
      ...
      const title = titleElements.find(
  ...
  describe('Validación de formulario', () => {
    ...
    it('debe mostrar error cuando el apellido está vacío', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('El apellido es requerido')
        ).toBeInTheDocument();
      });
    });
    ...
    it('debe mostrar error cuando el email no es válido', async () => {
      ...
      const confirmarContraseñaInput = screen.getByLabelText(
      ...
      await act(async () => {
        ...
        fireEvent.change(confirmarContraseñaInput, {
          target: { value: '123456' },
        });
  ...
  describe('Envío del formulario', () => {
    ...
    it('debe mostrar error cuando el registro falla', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('El email o nombre de usuario ya están en uso')
        ).toBeInTheDocument();
      });
    });
  ...
  describe('Navegación', () => {
    it('debe redirigir a login cuando el registro es exitoso', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.queryByText('El email o nombre de usuario ya están en uso')
        ).not.toBeInTheDocument();
      });
    });
  });
