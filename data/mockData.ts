...
export const mockPatos: Pato[] = [
  {
    ...
    comportamiento:
      'Gregario, forma bandadas numerosas. Muy activo durante el amanecer y atardecer.',
    habitat: 'Lagunas, esteros, ríos de corriente lenta y ambientes palustres',
    plumaje:
      'Dorso pardo moteado, vientre blanquecino con manchas oscuras, pico amarillo',
  ...
  },
  {
    ...
    comportamiento:
      'Muy gregario, forma grandes bandadas. Emite silbidos característicos en vuelo.',
    habitat: 'Lagunas profundas, esteros y humedales con vegetación abundante',
    plumaje:
      'Cabeza y cuello blancos con corona negra, dorso castaño, flancos rayados',
  ...
  },
  {
    ...
    descripcion:
      'Pato buceador robusto, endémico de Sudamérica. Los machos presentan un llamativo plumaje nupcial.',
    comportamiento:
      'Buceador experto, puede sumergirse hasta 3 metros de profundidad.',
    habitat: 'Lagunas profundas, embalses y grandes cuerpos de agua',
    plumaje:
      'Macho: cabeza negra con reflejos verdes, pecho castaño. Hembra: parda con vientre claro',
  ...
  },
  {
    ...
    comportamiento:
      'Territorial durante la época reproductiva, forma parejas estables.',
    habitat: 'Lagos, lagunas, ríos y costas marinas',
    plumaje:
      'Plumaje general pardo con tonos rojizos, espejo alar verde brillante',
    alimentacion:
      'Omnívoro: vegetación acuática, invertebrados, pequeños peces',
    especie: 'Anas',
    imagen: '/placeholder.svg?height=300&width=400',
  ...
  },
  {
    ...
    comportamiento:
      'Nada en círculos para crear corrientes que concentren el alimento.',
    habitat: 'Lagunas someras, bañados y humedales con agua poco profunda',
    plumaje:
      'Macho: cabeza verde, pecho blanco, flancos castaños. Hembra: moteada en tonos pardos',
    alimentacion:
      'Filtrador: plancton, semillas pequeñas, invertebrados microscópicos',
    especie: 'Spatula',
    imagen: '/placeholder.svg?height=300&width=400',
