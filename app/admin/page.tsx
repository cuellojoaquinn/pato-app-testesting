    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">Gestiona las especies de patos en el catálogo</p>
        </div>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>{editingPato ? "Editar Especie" : "Agregar Nueva Especie"}</DialogTitle>
              <DialogDescription>
                {editingPato ? "Modifica los datos de la especie" : "Completa la información de la nueva especie"}
              </DialogDescription>
            </DialogHeader>
            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" onClick={() => handleEdit(pato)}>
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 line-clamp-3">{pato.descripcion}</p>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      {patos.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-500 text-lg">No hay especies registradas. ¡Agrega la primera!</p>
        </div>
      )}
    </div>
  )
