    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Explora las fascinantes especies de patos que habitan en Argentina
        </p>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
        <div className="grid md:grid-cols-4 gap-4">
          ...
          <Select
            ...
            onValueChange={value =>
              setFilters(prev => ({ ...prev, especie: value }))
            }
          >
            <SelectTrigger>
          ...
          <Input
            ...
            onChange={e =>
              setFilters(prev => ({ ...prev, habitat: e.target.value }))
            }
          />
          ...
          <Input
            ...
            onChange={e =>
              setFilters(prev => ({ ...prev, alimentacion: e.target.value }))
            }
          />
        </div>
      </div>
            ...
            <CardContent>
              ...
              {user.plan === 'gratuito' && (
                <p className="text-xs text-amber-600 mt-2">
                  🔒 Sonidos disponibles en plan Premium
                </p>
              )}
            </CardContent>
          </Card>
      ...
      {patos.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-500 text-lg">
            No se encontraron patos con los filtros aplicados
          </p>
        </div>
      )}
    </div>
